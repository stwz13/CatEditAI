...
int AbsVal_x86_avx::forward_inplace(Mat& bottom_top_blob, const Option& opt) const
{
...
int AbsVal_x86_avx::forward_inplace_bf16s_fp16s(Mat& bottom_top_blob, const Option& opt) const
{
    const int w = bottom_top_blob.w;
    const int h = bottom_top_blob.h;
    const int d = bottom_top_blob.d;
