...
int Padding_x86_avx::create_pipeline(const Option& opt)
{
...
int Padding_x86_avx::destroy_pipeline(const Option& /*opt*/)
{
...
int Padding_x86_avx::forward_bf16s_fp16s(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
    int w = bottom_blob.w;
    int h = bottom_blob.h;
    int d = bottom_blob.d;
