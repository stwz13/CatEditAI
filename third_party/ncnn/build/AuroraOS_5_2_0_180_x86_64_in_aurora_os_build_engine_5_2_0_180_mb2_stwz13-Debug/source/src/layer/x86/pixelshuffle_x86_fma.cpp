...
#include "pixelshuffle_x86_fma.h"
...
PixelShuffle_x86_fma::PixelShuffle_x86_fma()
{
}

int PixelShuffle_x86_fma::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
